                    ...
                    <div class="grid grid-cols md:grid-cols-1 gap-4">
                        <div class="form-group mb-2">
                            ...
                            <div
                                ...
                                <div class="md:text-xl font-bold px-4">Rp.{{ number_format($paymentMethod->total) }}</div>
                                <input type="hidden" name="total" value="{{ $paymentMethod->total }}">
                            </div>
                        </div>
                        <label class="block text-lg font-medium text-gray-900 dark:text-gray-300" for="upload_file">Bukti
                            Pembayaran</label>
                        <input

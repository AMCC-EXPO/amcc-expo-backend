...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="{{ route('admin.dashboard') }}">
            {{-- <img class="object-cover w-8 h-8 rounded-full" src="{{ asset('img/amcc.png') }}" alt=""
                aria-hidden="true" /> --}}
            EXPO AMCC
        </a>
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                <span class="ml-4">Member</span>
                </a>
            </li>

            <li class="relative px-6 py-3">
                @if (Request::is('admin/divisions*'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true">
                    </span>
                    <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
            ...
            <li class="relative px-6 py-3">
                @if (Request::is('admin/payment-methods*'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true">
                    </span>
                    <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                ...
                <span class="ml-4">Metode Pembayaran</span>
                </a>
            </li>

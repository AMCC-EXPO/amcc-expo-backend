                ...
                <form enctype="multipart/form-data" action="{{ route('admin.faqs.store') }}" method="POST">
                    ...
                    <label class="block text-sm">
                        ...
                        <textarea
                            ...
                            rows="3" placeholder="Enter some long form content." name="question"></textarea>
                    </label>
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <textarea
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:focus:shadow-outline-gray"
                            rows="3" placeholder="Enter some long form content." name="answer"></textarea>
                    </label>

    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="grid gap-6 mb-8">
            <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                <form enctype="multipart/form-data" action="{{ route('admin.payment-methods.update', [$paymentMethod->id]) }}" method="POST">
                    @csrf
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            ...
                            name="name" placeholder="ex. BCA" value="{{ $paymentMethod->name }}"/>
                    </label>
                    ...
                    <label class="mt-4 block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="receiver_name" placeholder="Nama Penerima" value="{{ $paymentMethod->receiver_name }}"/>
                    </label>
                    ...
                    <label class="mt-4 block text-sm">
                        ...
                        <input type="number"
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="receiver_number" placeholder="Rekening Penerima" value="{{ $paymentMethod->receiver_number }}"/>
                    </label>
                    ...
                    <label class="mt-4 block text-sm">
                        ...
                        <input type="number"
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="fee" placeholder="Biaya Tambahan" value="{{ $paymentMethod->fee }}"/>
                    </label>
                        ...
                        <div class="mt-2">
                            <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                                <input type="radio"
                                    ...
                                    name="is_ots" value="1" {{ ($paymentMethod->is_ots == true) ? "checked" : "" }}/>
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
                                <input type="radio"
                                    class="text-blue-600 form-radio focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:focus:shadow-outline-gray"
                                    name="is_ots" value="0" {{ ($paymentMethod->is_ots == false) ? "checked" : "" }}/>
                    ...
                    <div class="mt-4 text-sm">
                        ...
                        <div class="mt-2">
                            <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                                <input type="radio"
                                    class="text-blue-600 form-radio focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:focus:shadow-outline-gray"
                                    name="is_active" value="1" {{ ($paymentMethod->is_active == true) ? "checked" : "" }}/>
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
                                <input type="radio"
                                    class="text-blue-600 form-radio focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:focus:shadow-outline-gray"
                                    name="is_active" value="0" {{ ($paymentMethod->is_active == false) ? "checked" : "" }}/>
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                    </div>
